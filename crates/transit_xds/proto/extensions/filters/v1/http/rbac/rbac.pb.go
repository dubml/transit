...
const file_extensions_filters_v1_http_rbac_rbac_proto_rawDesc = "" +
	...
	"\x04when\x18\x02 \x03(\v2*.extensions.filters.http.rbac.v1.ConditionR\x04when\"W\n" +
	"\x06Source\x12-\n" +
	...
	"\n" +
	"not_values\x18\x03 \x03(\tR\tnotValuesBAZ?github.com/dubml/xds-api/extensions/filters/v1/http/rbac;rbacv1b\x06proto3"
