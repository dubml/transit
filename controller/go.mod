module github.com/kdubbo/transit/controller

go 1.26.0

require (
	github.com/kdubbo/xds-api v0.0.0
...
require (
	...
	istio.io/api v1.30.0-alpha.1.0.20260626010135-ac56ebb29e59 // indirect
	istio.io/client-go v1.30.0-alpha.1.0.20260626010535-0382ab2d50df // indirect
...
replace github.com/kdubbo/xds-api => ../crates/xds/proto
